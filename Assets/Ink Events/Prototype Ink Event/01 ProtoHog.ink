...
=== hogYesFail===
You make a break for the pig, but your crew members trip over themselves in their own glee and you all tumble into the dirt before crashing into a dead tree. 
    ~causeEvent(5)
    By some stroke of luck, the tree has a cache of fuel in it—just not the food you were so looking forward to…
->END
